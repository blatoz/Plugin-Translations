...
public class UltimateAntiBotVelocity implements IAntiBotPlugin, IServerPlatform {
    ...
    public void onProxyInitialization(ProxyInitializeEvent event) {
        ...
        try {
            ...
            this.logHelper.error("[ERROR] Hiba config.yml & messages.yml betöltése közben!");
            throw e;
        }
        //Version.init(this);
        ...
        this.logHelper.info("&cUltimateAntiBot §fbetöltve!");
        this.logHelper.sendLogo();
        this.logHelper.info("§cVerzió: §f$1 &4| §cKészítő: §f$2 §4| §cMagok: §f$3 §4| §cMód: &f$4"
                .replace("$1", VERSION)
                .replace("$2", AUTHOR)
                .replace("$3", String.valueOf(PerformanceHelper.getCores()))
                .replace("$4", String.valueOf(PerformanceHelper.get())));
        this.logHelper.info("§fAz §cabyss&f készen fel szívni a botokat!");
        ...
        this.logHelper.info("&c" + b + "ms&7-ig tartott a betölteni.");
        new Updater(this);
    }
    ...
    public void onProxyShutDownEvent(ProxyShutdownEvent event) {
        ...
        this.logHelper.info("&cKöszönjük hogy minket választott!");
        long b = System.currentTimeMillis() - a;
        this.logHelper.info("&c" + b + "ms&7-ig tartott a leállás.");
    }
