...
public class Config implements IConfiguration {
    ...
    public void createConfiguration(String file) {
        try {
            ...
            if (!configFile.exists()) {
                ...
                this.plugin.log(LogHelper.LogType.INFO, "Fájl " + configFile + " létre lett hozva!");
            }
        } catch (IOException e) {
            this.plugin.log(LogHelper.LogType.INFO,"Nem sikerült létrehozni a konfigurációs fájlt '" + file + "'!");
            e.printStackTrace();
        }
    }
    ...
    public void saveConfiguration(YamlConfiguration configuration, String file) {
        ...
        try {
            ...
            this.plugin.log(LogHelper.LogType.INFO,"Nem sikerült menteni a konfigurációs fájlt '" + replacedFile + "'!");
            e.printStackTrace();
        }
    }
    ...
    public void deleteConfiguration(String file) {
        ...
        if (file1.exists()) {
            file1.delete();
            this.plugin.log(LogHelper.LogType.INFO,"Fájl " + replacedFile + " törölve lett!");
        }
    }
